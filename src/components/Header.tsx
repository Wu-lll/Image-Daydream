...
export default function Header() {
  ...
  return (
    <header className="brand-header sticky top-0 z-40 overflow-hidden border-b border-[rgba(63,86,110,0.12)] bg-[rgba(245,248,251,0.88)] backdrop-blur-xl dark:bg-gray-950/80 dark:border-white/[0.08]">
      <div className="relative z-10 mx-auto flex min-h-[7.35rem] max-w-7xl items-start justify-center px-4 py-4 sm:min-h-[8.1rem] sm:py-4">
        ...
        <div className="flex w-full max-w-[38rem] flex-col items-center pt-0.5 text-center">
          ...
          <div className="mt-3 flex flex-wrap items-center justify-center gap-2 text-xs text-[rgba(29,39,49,0.82)] sm:text-sm">
            <span className="brand-pill rounded-full border border-[rgba(63,86,110,0.12)] bg-[rgba(248,251,255,0.88)] px-3.5 py-1 shadow-[0_8px_24px_rgba(42,59,77,0.06)]">
        ...
        <div className="absolute right-4 top-4 flex items-center gap-2 sm:right-5 sm:top-4">
          <button
