...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[rgba(63,86,110,0.12)] bg-[rgba(245,248,251,0.88)] backdrop-blur-xl dark:bg-gray-950/80 dark:border-white/[0.08]">
      <div className="relative mx-auto flex min-h-[8.75rem] max-w-7xl items-start justify-center px-4 py-5 sm:min-h-[9.5rem] sm:py-6">
        <div className="absolute left-4 top-5 sm:left-5 sm:top-6">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-[rgba(29,39,49,0.16)] bg-[rgb(29,39,49)] text-white shadow-[0_12px_28px_rgba(42,59,77,0.16)] sm:h-12 sm:w-12">
        ...
        <div className="flex w-full max-w-[38rem] flex-col items-center pt-0.5 text-center">
          <h1 className="[font-family:var(--font-brand-script)] text-4xl font-normal leading-none text-[rgb(20,38,58)] sm:text-7xl">
            Image Daydream
          </h1>
          <div className="mt-2 flex w-full max-w-[22rem] items-center justify-center gap-3 text-sm tracking-[0.28em] text-[rgba(29,39,49,0.76)]">
          ...
          <div className="mt-4 flex flex-wrap items-center justify-center gap-3 text-sm text-[rgba(29,39,49,0.82)]">
            <span className="rounded-full border border-[rgba(63,86,110,0.12)] bg-[rgba(248,251,255,0.88)] px-4 py-1.5 shadow-[0_8px_24px_rgba(42,59,77,0.06)]">
        ...
        <div className="absolute right-4 top-5 flex items-center gap-2 sm:right-5 sm:top-6">
          <button
            ...
            className="rounded-full border border-[rgba(63,86,110,0.1)] bg-[rgba(248,251,255,0.86)] p-2.5 shadow-[0_10px_26px_rgba(42,59,77,0.08)] transition-colors hover:border-[rgba(63,86,110,0.18)] hover:bg-white dark:hover:bg-gray-900"
            title="操作指南"
          >
            <svg
