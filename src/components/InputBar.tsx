...
export default function InputBar() {
  ...
  const hasUsableCredentials = settings.credentialMode === 'site' || Boolean(settings.apiKey.trim())
  const canSubmit = Boolean(prompt.trim() && hasUsableCredentials)
          ...
          <div className="mt-3">
            ...
            <div className="hidden sm:flex items-end justify-between gap-3">
              ...
              <div className="flex gap-2 flex-shrink-0 mb-0.5">
                ...
                >
                  <ButtonTooltip visible={!hasUsableCredentials && submitHover} text="尚未完成 API 配置，请在右上角设置中进行" />
                  <button
